...
import './GameThumbBox2.less'

const GameThumbBox2 = (props) => {
    const {loading, link, url, name, tags = 0} = props;

    const viewTags = (tagsval) => {
        switch(tagsval){
            case 1 :
                return <svg style={{
                            position: 'absolute',
